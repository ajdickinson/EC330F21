...
.pull-right[
![:scale 53%](figures/four-skills.png)

![:scale 53%](figures/six-skills.png)
]
...
- The economic forces that cause clustering that act on firms .hii[across different] industries
...
> A major city that works as the .hi[financial, political, and population center of a country] and is not rivaled in any of these aspects by any other city in that country. Normally, a primate city must be at least .blue[twice as populous as the second largest city] in the country.
