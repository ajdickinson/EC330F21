...
.hi[Definition:] The relationship between prices and quantities (demanded)
...
.hi[Supply curves] are constructed from .hii[producers] making optimal production decisions
...
.center[
```{r, plot03, echo = FALSE, fig.width = 9, fig.height = 6}
