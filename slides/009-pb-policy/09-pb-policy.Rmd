...
- Only scratches the surface of how one may .hii[model the effects] of a place-based policy
...
Zoning restrictions $\implies$ limited housing supply $\implies$ high rents $\implies$ move to Oregon
...
.qa[A:] One more right shoe does nothing for me unless I get one more left shoe
