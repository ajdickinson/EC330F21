...
.ul[.bigger[.hi-white[Upcoming:]]]
  ...
  - .hi-white[PS01 due tonight at 12pm]
  
  - .hi-white[Be on the look out for PS02]
  ]
...
[Data](https://ajdickinson.github.io/ec330-fall21/slides/005-rents/data.html)
...
--
  ...
  - Each household has $800 a month to spend
    - Split between housing and commuting
...
.qa[Q]: If you are trying to move to a better area, would you choose to sacrifice (_"substitute"_) apartment size?

--

.center[.qa[A]: Probably yes. Most people are willing to .blue[substitute]]

--

.qa[Q]: What do I mean by .blue[substitute]? Substitute what?

--

.center[.qa[A]: Substitute housing consumption for .blue[lower commuting cost] ]
...
.qa[Q]: Did our model of locational indifference accomdate for substitution?
...
.qa[A]: No because $h$ (_quantity of housing consumed_) is .hi[independent of distance] from center, $x$ 
...
- Further from labor $\implies$ .orange[higher wage] (compensating commuting costs)
